...
"
Remove-Item -ErrorAction SilentlyContinue .graphify/.graphify_detect.json, .graphify/.graphify_extract.json, .graphify/.graphify_ast.json, .graphify/.graphify_semantic.json, .graphify/.graphify_analysis.json, .graphify/.graphify_labels.json
