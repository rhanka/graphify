...
| Safi Python Graphify | post-`v0.4.27` `upstream/v4` | `5843ffc277c54766854f9201286c9647da095390` | `upstream/v4` | `0.4.28`..`0.4.31` line | `partial` | Runtime drift is largely covered in this branch; remaining delta is Python-specific packaging/docs polish, not core TypeScript runtime behavior. |
