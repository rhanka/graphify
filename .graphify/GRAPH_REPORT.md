...
## Corpus Check
- Large corpus: 211 files · ~238,336 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1419 nodes · 2539 edges · 64 communities detected
...
- Included files: 211 · Candidates: 231
- Excluded: 0 untracked · 18344 ignored · 0 sensitive · 0 missing committed
...
Cohesion: 0.04
Nodes (55): estimateTokens(), loadGraph(), querySubgraphTokens(), runBenchmark(), buildFlowArtifact(), computeFlowCriticality(), decoratorsOf(), detectEntryPoints() (+47 more)
...
Cohesion: 0.06
Nodes (32): canonicalizeForPartition(), cluster(), cohesionScore(), partition(), scoreAll(), splitCommunity(), createGraph(), forEachTraversalNeighbor() (+24 more)
...
- **Thin community `Community 53`** (2 nodes): `build_graph()`, `Graph`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (2 nodes): `addFunction()`, `qn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (2 nodes): `addNode()`, `qn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (1 nodes): `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (2 nodes): `runCliInTemp()`, `runCliWithEnvironment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `ValidationError` connect `Community 7` to `Community 0`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `Cookies` connect `Community 0` to `Community 22`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
