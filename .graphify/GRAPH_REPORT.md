...
## Corpus Check
- Large corpus: 208 files · ~232,398 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1372 nodes · 2618 edges · 40 communities detected
...
- Excluded: 0 untracked · 184 ignored · 0 sensitive · 0 missing committed
