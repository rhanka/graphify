...
## Corpus Check
- Large corpus: 237 files · ~286,281 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2497 nodes · 4839 edges · 92 communities detected
...
- Included files: 237 · Candidates: 253
- Excluded: 0 untracked · 20213 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `55da21b`
...
Cohesion: 0.05
Nodes (45): execGit(), gitRevParse(), resolveFromGitCwd(), resolveGitContext(), safeExecGit(), safeGitRevParse(), execGit(), gitRevParse() (+37 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (41): bfs(), communitiesFromGraph(), communityName(), dfs(), findNode(), getVersion(), loadGraph(), scoreNodes() (+33 more)
...
Cohesion: 0.07
Nodes (48): buildProfileChunkPrompt(), buildProfileExtractionPrompt(), buildProfileValidationPrompt(), chunkGuidance(), citationSection(), genericSafetySection(), hardeningSection(), inputHintsSection() (+40 more)
...
Cohesion: 0.1
Nodes (35): addError(), addWarning(), appendJsonLine(), applyOntologyPatch(), auditPath(), changedFiles(), isInside(), isRecord() (+27 more)
...
Cohesion: 0.09
Nodes (31): classifyFile(), convertOfficeFile(), countWords(), detect(), detectIncremental(), docxToMarkdown(), findVcsRoot(), hasCodeShebang() (+23 more)
...
Cohesion: 0.08
Nodes (10): analyzeChanges(), changedNodesFromFiles(), mapChangesToNodes(), sortNodesByLocation(), uniqueSorted(), analyzeChanges(), changedNodesFromFiles(), mapChangesToNodes() (+2 more)
...
Cohesion: 0.18
Nodes (22): buildFallbackSidecar(), buildWikiDescriptionPrompt(), collectCommunityTargetContext(), collectInferredCommunityMap(), collectNodeNeighbors(), collectNodeTargetContext(), collectSourceRefs(), collectWikiDescriptionTargets() (+14 more)
...
Cohesion: 0.11
Nodes (8): createDirectTextJsonClient(), defaultDirectLlmModel(), directProviderCredentialEnv(), ensureProviderCredential(), isDirectLlmProvider(), preflightLlmExecution(), resolveDirectModel(), resolveProviderCredential()
...
Cohesion: 0.24
Nodes (13): antigravityInstall(), claudeInstall(), cursorInstall(), emptyPreview(), geminiInstall(), globalSkillInstallPreview(), installClaudeHook(), installGeminiMcp() (+5 more)

### Community 64 - "Community 64"
Cohesion: 0.21
Nodes (7): readGraphAttributeLabels(), readLabelsJson(), resolveCommunityLabels(), builtFromCommit(), checkUpdate(), mergeHyperedges(), rebuildCode()
...
Cohesion: 0.29
Nodes (8): buildWikiDescriptionCacheKey(), createInsufficientEvidenceRecord(), isNonEmptyString(), isRecord(), isStringArray(), isStringOrNull(), sha256(), validateWikiDescriptionSidecar()
...
- **Thin community `Community 38`** (2 nodes): `AsyncClient`, `Client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (2 nodes): `ApiClient`, `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `AsyncClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `Client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (2 nodes): `ConnectionPool`, `HTTPTransport`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (2 nodes): `runCliInTemp()`, `runCliWithEnvironment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Cookies` connect `Community 52` to `Community 42`, `Community 31`, `Community 38`, `Community 20`, `Community 25`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Cookies` connect `Community 37` to `Community 42`, `Community 67`, `Community 61`, `Community 25`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `InvalidURL` connect `Community 37` to `Community 20`, `Community 67`, `Community 61`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
