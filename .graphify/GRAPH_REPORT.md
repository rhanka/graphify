...
## Corpus Check
- Large corpus: 211 files · ~238,267 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1419 nodes · 2710 edges · 44 communities detected
...
- Excluded: 1 untracked · 230 ignored · 0 sensitive · 0 missing committed
...
Cohesion: 0.03
Nodes (67): analyzeChanges(), changedNodesFromFiles(), mapChangesToNodes(), sortNodesByLocation(), uniqueSorted(), buildFlowArtifact(), computeFlowCriticality(), decoratorsOf() (+59 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (65): build(), buildFromJson(), buildMerge(), deduplicateByLabel(), normalizedLabel(), normalizeSourceFilePath(), applyConfiguredExcludes(), buildConfiguredDetectionInputs() (+57 more)
...
Cohesion: 0.07
Nodes (40): execGit(), gitRevParse(), resolveFromGitCwd(), resolveGitContext(), safeExecGit(), safeGitRevParse(), appendMemoryFiles(), buildGitInventory() (+32 more)
...
Cohesion: 0.06
Nodes (29): normalizeSearchText(), scoreSearchText(), textMatchesQuery(), bfs(), communitiesFromGraph(), communityName(), dfs(), findNode() (+21 more)
...
Cohesion: 0.1
Nodes (27): bodyContent(), cachedFiles(), cacheDir(), cacheKind(), cacheNamespace(), checkSemanticCache(), clearCache(), collectJsonStems() (+19 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (20): estimateTokens(), loadGraph(), querySubgraphTokens(), runBenchmark(), createGraph(), forEachTraversalNeighbor(), isDirectedGraph(), loadGraphFromData() (+12 more)
...
- **Thin community `Community 35`** (1 nodes): `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (2 nodes): `build_graph()`, `Graph`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (1 nodes): `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (2 nodes): `runCliInTemp()`, `runCliWithEnvironment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
