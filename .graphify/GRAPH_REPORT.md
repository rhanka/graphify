...
## Corpus Check
- Large corpus: 242 files · ~300 477 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2570 nodes · 4987 edges · 97 communities detected
...
- Included files: 242 · Candidates: 258
- Excluded: 0 untracked · 20261 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `cd7b6b4`
...
Cohesion: 0.06
Nodes (44): communityArticle(), crossCommunityLinks(), buildFallbackSidecar(), buildWikiDescriptionPrompt(), collectCommunityTargetContext(), collectInferredCommunityMap(), collectNodeNeighbors(), collectNodeTargetContext() (+36 more)
...
Cohesion: 0.07
Nodes (17): estimateFileTokens(), extractionShape(), extractSemanticFilesDirectParallel(), mergeExtractions(), packSemanticFilesByTokenBudget(), readSemanticFile(), toPortableRelative(), createDirectTextJsonClient() (+9 more)
...
Cohesion: 0.1
Nodes (21): normalizeSearchText(), scoreSearchText(), textMatchesQuery(), analyzeGraph(), cacheOptionsFromRuntime(), defaultLabels(), ensureExtractionShape(), getVersion() (+13 more)
...
Cohesion: 0.15
Nodes (10): readGraphAttributeLabels(), readLabelsJson(), resolveCommunityLabels(), acquireRebuildLock(), builtFromCommit(), checkUpdate(), mergeHyperedges(), rebuildCode() (+2 more)
...
- **Thin community `Community 58`** (2 nodes): `ApiClient`, `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (1 nodes): `AsyncClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `Client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `ConnectionPool`, `HTTPTransport`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `discoveryContext()`, `semanticDetection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `runCliInTemp()`, `runCliWithEnvironment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Cookies` connect `Community 52` to `Community 45`, `Community 32`, `Community 40`, `Community 19`, `Community 26`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Cookies` connect `Community 39` to `Community 45`, `Community 72`, `Community 68`, `Community 26`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `InvalidURL` connect `Community 39` to `Community 19`, `Community 72`, `Community 68`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
