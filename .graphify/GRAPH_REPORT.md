...
## Corpus Check
- 391 files · ~467,511 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5489 nodes · 10621 edges · 225 communities detected
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 466 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4678 · calls: 2549 · imports: 1136 · imports_from: 674 · re_exports: 552 · uses: 466 · method: 274 · rationale_for: 208 · inherits: 68 · defines: 16


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 391 · Candidates: 428
- Excluded: 0 untracked · 28333 ignored · 8 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `e062499`
...
Cohesion: 0.05
Nodes (70): asRecord(), bucketMatches(), calibrateImageRouting(), countArray(), imageRoutingSampleFromCaption(), loadImageRoutingLabels(), loadImageRoutingRules(), normalizeBucket() (+62 more)
...
Cohesion: 0.07
Nodes (54): asRecord(), asStringArray(), bindOntologyProfile(), hashOntologyProfile(), loadOntologyProfile(), normalizeCitationPolicy(), normalizeHardeningPolicy(), normalizeOntologyProfile() (+46 more)
...
Cohesion: 0.07
Nodes (42): BACKUP_ARTIFACTS, buildFreshnessMetadata(), buildGraphHtml(), CanvasOptions, COMMUNITY_COLORS, CommunityLabelOptions, CommunityLabelsInput, computeTopologySignature() (+34 more)
...
Cohesion: 0.05
Nodes (43): GraphifyDataprepPolicy, GraphifyImageAnalysisBatchPolicy, GraphifyImageAnalysisCalibrationPolicy, GraphifyImageAnalysisPolicy, GraphifyImageArtifactSource, GraphifyLlmExecutionBatchPolicy, GraphifyLlmExecutionMeshPolicy, GraphifyLlmExecutionMode (+35 more)
...
Cohesion: 0.08
Nodes (25): acquire2DContext(), acquireContext(), applyDash(), AttributeLocations, buildEdgeColors(), buildNodeColors(), compileShader(), createBuffer() (+17 more)
...
Cohesion: 0.16
Nodes (23): buildGraphIndex(), candidateSubgraph(), citationsByFile(), computeCommunityStats(), displayValue(), graphEdges(), graphNodes(), groupCounts() (+15 more)
...
Cohesion: 0.13
Nodes (21): normalizeCommunityLabel(), persistCommunityLabels(), readGraphAttributeLabels(), readLabelsJson(), resolveCommunityLabels(), ExtractionDiagnostic, buildProject(), BuildProjectArtifacts (+13 more)
...
Cohesion: 0.12
Nodes (21): buildStudioScene(), BuildStudioSceneOptions, communityLiveCount(), computeDegrees(), displayValue(), graphEdges(), graphNodes(), nodeCommunity() (+13 more)
...
Cohesion: 0.12
Nodes (16): ProfileState, evidenceRefsFromSources(), loadOntologyPatchContext(), loadProfilePatchRuntimeContext(), optionalJson(), ProfilePatchRuntimeContext, readJson(), stringValue() (+8 more)
...
Cohesion: 0.12
Nodes (10): OntologyWriteFixture, writeOntologyWriteFixture(), OntologyPatch, GRAPH_FIXTURE, tempDirs, dir, fixture, html (+2 more)
...
Cohesion: 0.16
Nodes (10): CameraState, FitViewOptions, GraphRenderer, GraphRendererOptions, GraphRendererSnapshot, HighLevelGraphInput, HighLevelGraphNode, LayoutOptions (+2 more)
...
Cohesion: 0.16
Nodes (13): communityStats(), entitiesByCommunity(), entitiesByType(), graphIndex(), byComm, byType, FIXTURE, hub (+5 more)
...
Cohesion: 0.26
Nodes (11): buildGraphRendererPayload(), clampUnit(), colorForGroup(), edgeWidth(), findNearestNodeId(), finite(), GROUP_PALETTE, interpolateMergePositions() (+3 more)
...
Cohesion: 0.20
Nodes (7): applyWeakFilter(), buildScene(), computeDegrees(), __dirname, EDGE_CASES, REPO_ROOT, SMALL_GRAPH
...
## Knowledge Gaps
- **1705 isolated node(s):** `Nt`, `Qs`, `Js`, `ur`, `fr` (+1700 more)
...
- **Thin community `Community 131`** (1 nodes): `app`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 172`** (2 nodes): `ignoredDir`, `inventory`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 174`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 192`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 216`** (2 nodes): `buildPatchFromCandidate()`, `cand`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 218`** (2 nodes): `delta`, `G`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 224`** (1 nodes): `UnpdfTextResult`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 225`** (1 nodes): `appSource`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 227`** (1 nodes): `here`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 228`** (2 nodes): `tempProfileProject()`, `tempProject()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 229`** (1 nodes): `optionalRuntimeDeps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `buildScene()` connect `Community 166` to `Community 145`, `Community 75`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `loadProjectConfig()` connect `Portable-check & detection portability` to `Recommendations (commit prefix, area)`, `Image routing calibration`, `MCP server (graph queries)`, `Community 58`, `Community 129`, `Sample corpus: httpx auth (worked/)`, `Review benchmark`, `Community 95`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `discoverProjectConfig()` connect `Portable-check & detection portability` to `Recommendations (commit prefix, area)`, `Image routing calibration`, `MCP server (graph queries)`, `Community 58`?**
