...
## Corpus Check
- 387 files · ~463,775 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5380 nodes · 10443 edges · 218 communities detected
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 466 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4573 · calls: 2479 · imports: 1133 · imports_from: 674 · re_exports: 552 · uses: 466 · method: 274 · rationale_for: 208 · inherits: 68 · defines: 16


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 387 · Candidates: 424
- Excluded: 0 untracked · 28304 ignored · 8 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `8008dc6`
...
Cohesion: 0.04
Nodes (56): $a(), ar, ba(), ci, dn, ec(), ei(), ft() (+48 more)
...
Cohesion: 0.06
Nodes (47): arcControl(), buildEdgePolylinePositions(), EdgeCurveMode, EdgePolylineOptions, Point, quadraticPoint(), readPoint(), assertPositionArray() (+39 more)
...
Cohesion: 0.10
Nodes (13): aa(), Ae(), ca(), ia(), ji(), la(), ls(), oa() (+5 more)
...
Cohesion: 0.17
Nodes (34): bt(), ce(), D(), Ee(), fl(), gi(), Gl(), gs() (+26 more)
...
Cohesion: 0.10
Nodes (27): An(), cs(), di(), ea(), eo(), Es(), go(), ha() (+19 more)
...
Cohesion: 0.11
Nodes (21): ao(), bo(), co(), Do(), Fr(), io(), Kn(), ko() (+13 more)

### Community 99 - "Community 99"
Cohesion: 0.11
Nodes (19): ds(), fi(), fo(), fs(), Gt(), hi(), ho(), _i() (+11 more)
...
Cohesion: 0.15
Nodes (12): Cn(), Fn(), gr(), jn(), Jt(), Kr, oo(), pi() (+4 more)
...
## Knowledge Gaps
- **1686 isolated node(s):** `hn`, `ci`, `Xr`, `Zr`, `lr` (+1681 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 116`** (2 nodes): `ApiClient`, `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (1 nodes): `app`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 167`** (2 nodes): `ignoredDir`, `inventory`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 168`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 187`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `buildScene()` connect `Community 161` to `Community 141`, `Community 74`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `loadProjectConfig()` connect `Sample corpus: httpx Python client (worked/)` to `Change detection & risk score`, `Ontology output (wiki, obsidian, etc.)`, `Input scope, git, repo clone`, `Community 58`, `Community 127`, `Tests: wiki description generation`, `Sample corpus: httpx utils (worked/)`, `Community 93`?**
