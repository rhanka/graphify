...
## Corpus Check
- 369 files · ~476,463 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5271 nodes · 10258 edges · 217 communities detected
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 466 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4481 · calls: 2453 · imports: 1098 · imports_from: 652 · re_exports: 542 · uses: 466 · method: 274 · rationale_for: 208 · inherits: 68 · defines: 16


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 369 · Candidates: 404
- Excluded: 19 untracked · 28230 ignored · 8 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `a61919f`
...
Cohesion: 0.11
Nodes (19): CODE_EXTENSIONS, DOC_EXTENSIONS, PAPER_EXTENSIONS, IMAGE_EXTENSIONS, WATCHED_EXTENSIONS, mergeHyperedges(), builtFromCommit(), rebuildCode() (+11 more)
...
Cohesion: 0.05
Nodes (72): readJsonl(), asRecord(), readCaption(), artifactHasDeepRoute(), existingValidSidecarErrors(), importImageDataprepBatchResults(), asRecord(), parseFile() (+64 more)
...
Cohesion: 0.09
Nodes (42): isWindowsAbsolutePath(), hasSchemePrefix(), portablePath(), stripLeadingDotSlash(), toProjectRelativePath(), projectRootLabel(), normalizeMaybePath(), normalizeScopePath() (+34 more)
...
## Knowledge Gaps
- **1660 isolated node(s):** `hn`, `ci`, `Xr`, `Zr`, `lr` (+1655 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 216`** (1 nodes): `UnpdfTextResult`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (1 nodes): `app`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 207`** (2 nodes): `buildPatchFromCandidate()`, `cand`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 209`** (2 nodes): `delta`, `G`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 217`** (2 nodes): `tempProject()`, `tempProfileProject()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (2 nodes): `ApiClient`, `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 186`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 210`** (2 nodes): `html`, `tokenLine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 164`** (2 nodes): `inventory`, `ignoredDir`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `buildScene()` connect `Community 158` to `Community 137`, `Community 72`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `loadProjectConfig()` connect `Portable-check & detection portability` to `Recommendations (commit prefix, area)`, `Image routing calibration`, `Input scope, git, repo clone`, `Community 56`, `Community 125`, `Sample corpus: httpx auth (worked/)`, `Review benchmark`, `Community 91`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `discoverProjectConfig()` connect `Portable-check & detection portability` to `Recommendations (commit prefix, area)`, `Image routing calibration`, `Input scope, git, repo clone`, `Community 56`?**
