...
## Corpus Check
- Large corpus: 235 files · ~283,379 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2468 nodes · 4780 edges · 89 communities detected
...
- Excluded: 2 untracked · 20209 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `0f11297`
...
- **Thin community `Community 39`** (2 nodes): `AsyncClient`, `Client`
...
- **Thin community `Community 69`** (2 nodes): `ConnectionPool`, `HTTPTransport`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (2 nodes): `runCliInTemp()`, `runCliWithEnvironment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Cookies` connect `Community 38` to `Community 43`, `Community 66`, `Community 60`, `Community 26`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `InvalidURL` connect `Community 38` to `Community 21`, `Community 66`, `Community 60`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
