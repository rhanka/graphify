...
## Corpus Check
- Large corpus: 218 files · ~250,602 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2332 nodes · 4471 edges · 84 communities detected
...
- Included files: 218 · Candidates: 234
- Excluded: 2 untracked · 19296 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `eed686c`
...
Cohesion: 0.06
Nodes (41): execGit(), gitRevParse(), resolveFromGitCwd(), resolveGitContext(), safeExecGit(), safeGitRevParse(), currentBranch(), currentHead() (+33 more)
...
Cohesion: 0.05
Nodes (33): bfs(), communitiesFromGraph(), communityName(), dfs(), findNode(), getVersion(), loadGraph(), scoreNodes() (+25 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (39): bodyContent(), cachedFiles(), cacheDir(), cacheKind(), cacheNamespace(), checkSemanticCache(), clearCache(), collectJsonStems() (+31 more)
...
Cohesion: 0.06
Nodes (17): antigravityUninstall(), changedFilesFromGit(), checkSkillVersion(), claudeUninstall(), ensureCliExtractionShape(), geminiUninstall(), getPlatformsToCheck(), loadCliProfileContext() (+9 more)
...
Cohesion: 0.1
Nodes (22): estimateTokens(), loadGraph(), querySubgraphTokens(), runBenchmark(), defaultGraphPath(), defaultManifestPath(), defaultTranscriptsDir(), legacyGraphPath() (+14 more)
...
Cohesion: 0.17
Nodes (22): antigravityInstall(), canonicalPlatformName(), claudeInstall(), cursorInstall(), emptyPreview(), findSkillFile(), geminiInstall(), getInvocationExample() (+14 more)
...
Cohesion: 0.17
Nodes (8): build(), buildFromJson(), buildMerge(), deduplicateByLabel(), normalizedLabel(), normalizeSourceFilePath(), assertValid(), validateExtraction()
...
- **Thin community `Community 54`** (2 nodes): `ApiClient`, `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `AsyncClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `Client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (2 nodes): `runCliInTemp()`, `runCliWithEnvironment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Cookies` connect `Community 14` to `Community 42`, `Community 38`, `Community 19`, `Community 24`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `Cookies` connect `Community 36` to `Community 42`, `Community 65`, `Community 61`, `Community 24`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `InvalidURL` connect `Community 36` to `Community 19`, `Community 65`, `Community 61`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
