...
## Corpus Check
- Large corpus: 230 files · ~264,949 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2403 nodes · 4634 edges · 86 communities detected
...
- Included files: 230 · Candidates: 246
- Excluded: 0 untracked · 20162 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `8e40f00`
...
- **Thin community `Community 77`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Cookies` connect `Community 15` to `Community 44`, `Community 41`, `Community 21`, `Community 27`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Cookies` connect `Community 39` to `Community 44`, `Community 66`, `Community 62`, `Community 27`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `InvalidURL` connect `Community 39` to `Community 21`, `Community 66`, `Community 62`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
