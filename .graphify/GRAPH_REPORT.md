...
## Corpus Check
- 387 files · ~463,436 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5373 nodes · 10429 edges · 219 communities detected
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 466 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4566 · calls: 2472 · imports: 1133 · imports_from: 674 · re_exports: 552 · uses: 466 · method: 274 · rationale_for: 208 · inherits: 68 · defines: 16


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 387 · Candidates: 425
- Excluded: 0 untracked · 28294 ignored · 8 sensitive · 1 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `6663389`
...
Cohesion: 0.04
Nodes (56): r(), hn, ci, Xr, Zr, lr, Re, dn (+48 more)

### Community 98 - "Community 98"
Cohesion: 0.11
Nodes (21): n(), ao(), io(), lo(), co(), vo(), vs(), Kn() (+13 more)

### Community 99 - "Community 99"
Cohesion: 0.11
Nodes (19): ii(), fi(), vi(), hi(), _i(), wi(), na(), ra() (+11 more)

### Community 43 - "Community 43"
Cohesion: 0.10
Nodes (13): Xs(), yi(), ji(), Ae(), aa(), ia(), tn, oa() (+5 more)

### Community 148 - "Community 148"
Cohesion: 0.15
Nodes (12): ui, Kr, pi(), Cn(), sa(), Jt(), Un(), oo() (+4 more)

### Community 64 - "Community 64"
Cohesion: 0.10
Nodes (27): Ks, Zs(), di(), Oi(), ea(), is(), eo(), cs() (+19 more)

### Community 49 - "Community 49"
Cohesion: 0.17
Nodes (34): gi(), Ni(), zi(), bt(), xt(), hr(), ue(), Rt() (+26 more)
...
Cohesion: 0.06
Nodes (47): EdgeCurveMode, EdgePolylineOptions, Point, readPoint(), quadraticPoint(), arcControl(), buildEdgePolylinePositions(), assertPositionArray() (+39 more)
...
Cohesion: 0.05
Nodes (62): OFFICE_EXTENSIONS, GOOGLE_WORKSPACE_EXTENSIONS, VIDEO_EXTENSIONS, SENSITIVE_PATTERNS, PAPER_SIGNALS, isSensitive(), looksLikePaper(), ASSET_DIR_MARKERS (+54 more)
...
Cohesion: 0.08
Nodes (41): BACKUP_ARTIFACTS, COMMUNITY_COLORS, inferNodeShape(), CONFIDENCE_SCORE_DEFAULTS, CommunityLabelsInput, CommunityLabelOptions, HtmlOptions, JsonOptions (+33 more)
...
Cohesion: 0.11
Nodes (21): ExtractionDiagnostic, BuildProjectOptions, BuildProjectWarning, BuildProjectArtifacts, BuildProjectResult, countNonCodeFiles(), formatDiagnosticSummary(), fileList() (+13 more)
...
Cohesion: 0.05
Nodes (70): asRecord(), parseFile(), stringArray(), numberValue(), countArray(), imageRoutingSampleFromCaption(), normalizeBucket(), loadImageRoutingLabels() (+62 more)
...
Cohesion: 0.08
Nodes (44): PortablePathIssueKind, PortablePathIssue, PortableCheckResult, LOCAL_LIFECYCLE_FILES, LOCAL_LIFECYCLE_PREFIXES, TEXT_ARTIFACT_EXTENSIONS, COMMON_POSIX_LOCAL_PATH_PREFIXES, isWindowsAbsolutePath() (+36 more)
...
Cohesion: 0.07
Nodes (29): ServeOptions, McpToolDefinition, McpResourceDefinition, GraphSnapshot, ReloadingGraphStore, MCP_RESOURCES, toolGodNodes(), toolGraphStats() (+21 more)
...
Cohesion: 0.14
Nodes (17): __filename, __dirname, StudioAssetResult, MIME_BY_EXT, TEXT_EXTS, resolveStudioAppDir(), mimeForPath(), isText() (+9 more)

### Community 85 - "Community 85"
Cohesion: 0.12
Nodes (21): StudioSceneGraphNode, StudioSceneGraphEdge, StudioSceneGraphLike, BuildStudioSceneOptions, StudioSceneNode, StudioSceneEdge, StudioSceneStats, StudioScene (+13 more)

### Community 68 - "Community 68"
Cohesion: 0.11
Nodes (26): compareStrings(), round(), maybeCommunity(), communityLabels(), graphDensity(), nodeSummary(), compareHubs(), communityMembership() (+18 more)
...
Cohesion: 0.16
Nodes (23): graphEdges(), graphNodes(), displayValue(), nodeLabel(), nodeType(), nodeGroup(), TYPE_SHAPE, REL_DASH (+15 more)

### Community 160 - "Community 160"
Cohesion: 0.20
Nodes (7): computeDegrees(), buildScene(), applyWeakFilter(), __dirname, REPO_ROOT, SMALL_GRAPH, EDGE_CASES

### Community 139 - "Community 139"
Cohesion: 0.16
Nodes (13): graphIndex(), communityStats(), entitiesByType(), entitiesByCommunity(), FIXTURE, scene, weak, strong (+5 more)
...
Cohesion: 0.12
Nodes (10): writeOntologyWriteFixture(), tempDirs, GRAPH_FIXTURE, tempDirs, dir, fixture, result, html (+2 more)
...
Cohesion: 0.29
Nodes (6): firstHopSummaryToText(), makeGraph(), summary, graph, textA, textB
...
Cohesion: 0.14
Nodes (9): tempDirs, dir, fixture, result, central, headingMatches, pills, sections (+1 more)
...
## Knowledge Gaps
- **1684 isolated node(s):** `hn`, `ci`, `Xr`, `Zr`, `lr` (+1679 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 218`** (1 nodes): `UnpdfTextResult`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `app`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 209`** (2 nodes): `buildPatchFromCandidate()`, `cand`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 211`** (2 nodes): `delta`, `G`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 219`** (2 nodes): `tempProject()`, `tempProfileProject()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (2 nodes): `ApiClient`, `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 188`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 212`** (2 nodes): `html`, `tokenLine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 166`** (2 nodes): `inventory`, `ignoredDir`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 220`** (1 nodes): `optionalRuntimeDeps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 167`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `buildScene()` connect `Community 160` to `Community 139`, `Community 74`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `loadProjectConfig()` connect `Sample corpus: httpx Python client (worked/)` to `Change detection & risk score`, `Ontology output (wiki, obsidian, etc.)`, `Input scope, git, repo clone`, `Community 58`, `Community 126`, `Sample corpus: httpx client (worked/)`, `Sample corpus: httpx utils (worked/)`, `Community 93`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `discoverProjectConfig()` connect `Sample corpus: httpx Python client (worked/)` to `Change detection & risk score`, `Ontology output (wiki, obsidian, etc.)`, `Input scope, git, repo clone`, `Community 58`?**
