...
## Corpus Check
- Large corpus: 215 files · ~239,649 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1419 nodes · 2539 edges · 70 communities detected
...
- Included files: 215 · Candidates: 231
- Excluded: 0 untracked · 18377 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `f98342b`
...
Cohesion: 0.05
Nodes (49): agentsInstall(), agentsUninstall(), antigravityInstall(), antigravityUninstall(), canonicalPlatformName(), changedFilesFromGit(), checkSkillVersion(), claudeInstall() (+41 more)
...
Cohesion: 0.06
Nodes (48): defaultGraphPath(), defaultManifestPath(), defaultTranscriptsDir(), legacyGraphPath(), resolveGraphifyPaths(), resolveGraphInputPath(), statePath(), detectUrlType() (+40 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (40): buildFlowArtifact(), computeFlowCriticality(), decoratorsOf(), detectEntryPoints(), flowIdFor(), flowListToText(), flowToSteps(), getFlowById() (+32 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (39): estimateTokens(), loadGraph(), querySubgraphTokens(), runBenchmark(), buildMinimalContext(), riskFromScore(), suggestionsForTask(), topCommunities() (+31 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (38): execGit(), gitRevParse(), resolveFromGitCwd(), resolveGitContext(), safeExecGit(), safeGitRevParse(), build(), buildFromJson() (+30 more)
...
Cohesion: 0.14
Nodes (24): Auth, BasicAuth, BearerAuth, NetRCAuth, Authentication handlers. Auth objects are callables that modify a request before, Load credentials from ~/.netrc based on the request host., Base class for all authentication handlers., Modify the request. May yield to inspect the response. (+16 more)
...
Cohesion: 0.11
Nodes (16): createGraph(), forEachTraversalNeighbor(), isDirectedGraph(), loadGraphFromData(), serializeGraph(), toUndirectedGraph(), traversalNeighbors(), hyperedgeSortKey() (+8 more)
...
Cohesion: 0.16
Nodes (16): currentBranch(), currentHead(), lifecyclePaths(), markLifecycleAnalyzed(), markLifecycleStale(), mergeBase(), planLifecyclePrune(), readJson() (+8 more)
...
Cohesion: 0.17
Nodes (11): Exception, CookieConflict, DecodingError, HTTPError, HTTPStatusError, An error occurred while issuing a request., Decoding of the response failed., A 4xx or 5xx response was received. (+3 more)
...
- **Thin community `Community 9`** (2 nodes): `AsyncClient`, `Client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `ConnectionPool`, `Manages a pool of persistent HTTP connections.     Keys connections by (scheme,`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (2 nodes): `build_graph()`, `Graph`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (2 nodes): `addFunction()`, `qn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (2 nodes): `addNode()`, `qn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (2 nodes): `runCliInTemp()`, `runCliWithEnvironment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `ValidationError` connect `Community 8` to `Community 43`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `Cookies` connect `Community 10` to `Community 7`, `Community 9`, `Community 43`, `Community 26`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `InvalidURL` connect `Community 7` to `Community 6`, `Community 43`, `Community 9`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
