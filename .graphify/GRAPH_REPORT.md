...
## Corpus Check
- Large corpus: 226 files · ~257,479 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2388 nodes · 4599 edges · 85 communities detected
...
- Included files: 226 · Candidates: 242
- Excluded: 0 untracked · 17714 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `e929fc9`
...
Cohesion: 0.09
Nodes (29): addError(), addWarning(), appendJsonLine(), applyOntologyPatch(), auditPath(), changedFiles(), isInside(), isRecord() (+21 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (29): evidenceRefsFromSources(), loadOntologyPatchContext(), loadProfilePatchRuntimeContext(), optionalJson(), readJson(), stringValue(), analyzeGraph(), cacheOptionsFromRuntime() (+21 more)
...
- **Thin community `Community 82`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (2 nodes): `runCliInTemp()`, `runCliWithEnvironment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Cookies` connect `Community 14` to `Community 44`, `Community 40`, `Community 21`, `Community 27`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `Cookies` connect `Community 38` to `Community 44`, `Community 66`, `Community 62`, `Community 27`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `InvalidURL` connect `Community 38` to `Community 21`, `Community 66`, `Community 62`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
