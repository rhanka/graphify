...
## Corpus Check
- Large corpus: 247 files · ~307 063 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.
...
- Excluded: 0 untracked · 16704 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `77cb314`
...
Cohesion: 0.6
Nodes (3): readLabelsJson(), readGraphAttributeLabels(), resolveCommunityLabels()
...
Cohesion: 0.05
Nodes (30): uniqueSorted(), sortNodesByLocation(), mapChangesToNodes(), changedNodesFromFiles(), analyzeChanges(), normalize(), uniqueSorted(), identifiers() (+22 more)
...
Cohesion: 0.36
Nodes (5): countNonCodeFiles(), formatDiagnosticSummary(), fileList(), buildProject(), defaultLabels()
...
Cohesion: 0.39
Nodes (8): qn(), addFunction(), addCall(), makeBenchmarkStore(), qn(), addFunction(), addCall(), makeBenchmarkStore()
...
- **Thin community `Community 96`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (2 nodes): `semanticDetection()`, `discoveryContext()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (2 nodes): `runCliInTemp()`, `runCliWithEnvironment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (2 nodes): `Client`, `AsyncClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
