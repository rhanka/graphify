...
## Corpus Check
- Large corpus: 235 files · ~277,095 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2459 nodes · 4759 edges · 89 communities detected
...
Cohesion: 0.07
Nodes (39): bfs(), communitiesFromGraph(), communityName(), dfs(), findNode(), getVersion(), loadGraph(), scoreNodes() (+31 more)
...
Cohesion: 0.09
Nodes (33): addError(), addWarning(), appendJsonLine(), applyOntologyPatch(), auditPath(), changedFiles(), isInside(), isRecord() (+25 more)
...
- **Thin community `Community 53`** (2 nodes): `ApiClient`, `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `AsyncClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `Client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (2 nodes): `ConnectionPool`, `HTTPTransport`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Cookies` connect `Community 50` to `Community 43`, `Community 30`, `Community 39`, `Community 22`, `Community 26`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Cookies` connect `Community 37` to `Community 43`, `Community 65`, `Community 59`, `Community 26`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `InvalidURL` connect `Community 37` to `Community 22`, `Community 65`, `Community 59`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
