...
## Corpus Check
- Large corpus: 208 files · ~228,938 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1381 nodes · 2634 edges · 41 communities detected
...
- Excluded: 0 untracked · 181 ignored · 0 sensitive · 0 missing committed
...
Cohesion: 0.05
Nodes (42): execGit(), gitRevParse(), resolveFromGitCwd(), resolveGitContext(), safeExecGit(), safeGitRevParse(), appendMemoryFiles(), buildGitInventory() (+34 more)
