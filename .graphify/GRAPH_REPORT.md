...
## Corpus Check
- 386 files · ~463,415 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5174 nodes · 9883 edges · 211 communities detected
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 466 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4409 · calls: 2125 · imports: 1133 · imports_from: 674 · re_exports: 552 · uses: 466 · method: 232 · rationale_for: 208 · inherits: 68 · defines: 16


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 386 · Candidates: 424
- Excluded: 6 untracked · 28331 ignored · 8 sensitive · 2 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `6e3b173`
...
Cohesion: 0.10
Nodes (39): applyWeakFilter(), buildGraphIndex(), buildScene(), candidateSubgraph(), citationsByFile(), communityStats(), computeCommunityStats(), computeDegrees() (+31 more)
...
## Knowledge Gaps
- **1679 isolated node(s):** `{ spawnSync }`, `{ dirname, join }`, `entry`, `cli`, `result` (+1674 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 109`** (2 nodes): `ApiClient`, `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (1 nodes): `app`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 160`** (2 nodes): `ignoredDir`, `inventory`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 162`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 180`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 203`** (2 nodes): `buildPatchFromCandidate()`, `cand`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 205`** (2 nodes): `delta`, `G`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 211`** (1 nodes): `UnpdfTextResult`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 212`** (1 nodes): `here`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 213`** (2 nodes): `tempProfileProject()`, `tempProject()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 214`** (1 nodes): `optionalRuntimeDeps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `buildScene()` connect `Test fixtures: C#/Java/PowerShell` to `Community 186`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `buildStudioScene()` connect `Community 83` to `Input scope, git, repo clone`, `Community 47`, `Community 89`, `Community 186`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `createReviewGraphStore()` connect `Community 50` to `Input scope, git, repo clone`, `Community 58`, `Sample corpus: mixed analyze.py (worked/)`, `Sample corpus: httpx auth (worked/)`, `Community 53`, `Sample corpus: httpx utils (worked/)`, `Review analysis (blast radius, communities)`, `Community 153`?**
