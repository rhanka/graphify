...
## Corpus Check
- Large corpus: 209 files · ~231,963 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1390 nodes · 2653 edges · 44 communities detected
...
- Excluded: 0 untracked · 206 ignored · 0 sensitive · 0 missing committed
...
Cohesion: 0.03
Nodes (73): analyzeChanges(), changedNodesFromFiles(), mapChangesToNodes(), sortNodesByLocation(), uniqueSorted(), buildFlowArtifact(), computeFlowCriticality(), decoratorsOf() (+65 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (53): estimateTokens(), loadGraph(), querySubgraphTokens(), runBenchmark(), applyConfiguredExcludes(), buildConfiguredDetectionInputs(), buildProfileState(), dataprepReport() (+45 more)
...
Cohesion: 0.06
Nodes (36): crossCommunitySurprises(), crossFileSurprises(), edgeBetweennessSurprises(), fileCategory(), godNodes(), isConceptNode(), isFileNode(), nodeCommunityMap() (+28 more)
...
Cohesion: 0.11
Nodes (14): createGraph(), forEachTraversalNeighbor(), isDirectedGraph(), loadGraphFromData(), serializeGraph(), toUndirectedGraph(), traversalNeighbors(), mergedGraphType() (+6 more)
...
- **Why does `ValidationError` connect `Community 13` to `Community 0`?**
