...
## Corpus Check
- 406 files · ~492,264 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5615 nodes · 10846 edges · 231 communities detected
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 466 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 4791 · calls: 2581 · imports: 1186 · imports_from: 704 · re_exports: 552 · uses: 466 · method: 274 · rationale_for: 208 · inherits: 68 · defines: 16


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 406 · Candidates: 443
- Excluded: 0 untracked · 28420 ignored · 8 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `96c0aec`
...
Cohesion: 0.13
Nodes (13): NodeId, GraphNodeShape, GraphRendererBackend, GraphRendererActiveBackend, HighLevelGraphNode, HighLevelGraphInput, NodeFlags, LayoutOptions (+5 more)
...
Cohesion: 0.08
Nodes (28): GraphCanvasLike, GraphContext, Graph2DContext, RendererState, AttributeLocations, UniformLocations, DrawProgram, RenderResources (+20 more)
...
Cohesion: 0.07
Nodes (44): GraphInstance, JSON_NOISE_LABELS, nodeCommunityMap(), isFileNode(), isConceptNode(), isJsonKeyNode(), fileCategory(), topLevelDir() (+36 more)
...
Cohesion: 0.13
Nodes (29): StatIndexEntry, statIndex, statIndexFile(), ensureStatIndex(), flushStatIndex(), statMtimeNs(), CacheOptions, bodyContent() (+21 more)
...
Cohesion: 0.15
Nodes (8): ProfileState, RegistryRecord, ProfileValidationResult, fixtureRoot, projectConfig, profile, registries, report
...
Cohesion: 0.06
Nodes (49): BACKUP_ARTIFACTS, todayIso(), backupIfProtected(), COMMUNITY_COLORS, inferNodeShape(), CONFIDENCE_SCORE_DEFAULTS, CommunityLabelsInput, CommunityLabelOptions (+41 more)
...
Cohesion: 0.14
Nodes (21): shellQuote(), normalizeGitPath(), collectEntries(), gitAdvice(), planGraphifyOutMigration(), applyEntry(), migrateGraphifyOut(), MigrationAction (+13 more)
...
Cohesion: 0.11
Nodes (27): stableJson(), sortJson(), sha256(), readJson(), writeJson(), wordCount(), relPath(), sortedSemanticFiles() (+19 more)

### Community 156 - "Community 156"
Cohesion: 0.17
Nodes (12): ontologyDiscoveryDiffToMarkdown(), semanticDetection(), discoveryContext(), OntologyDiscoveryProposalsFile, OntologyDiscoveryContext, fixtureRoot, sample, repeat (+4 more)
...
Cohesion: 0.42
Nodes (7): readJson(), optionalJson(), stringValue(), evidenceRefsFromSources(), loadProfilePatchRuntimeContext(), loadOntologyPatchContext(), ProfilePatchRuntimeContext
...
Cohesion: 0.07
Nodes (55): DEFAULT_STATUSES, VALID_CITATION_MINIMUMS, VIS_JS_SHAPE_LIST, VIS_JS_SHAPES, asRecord(), asStringArray(), normalizeStringMap(), relationEndpoints() (+47 more)
...
Cohesion: 0.11
Nodes (31): sampleLimit(), nodeTypeSection(), relationTypeSection(), relationMetadataSection(), registrySection(), citationSection(), hardeningSection(), inferencePolicySection() (+23 more)

### Community 148 - "Community 148"
Cohesion: 0.14
Nodes (11): chunkGuidance(), buildProfileChunkPrompt(), OntologyDiscoverySample, fixtureRoot, prompt, state, documentPrompt, imagePrompt (+3 more)
...
Cohesion: 0.08
Nodes (48): SECRET_KEY_PATTERNS, VALID_MIRROR_MODES, CONFIG_CANDIDATES, VALID_PDF_OCR_MODES, VALID_CITATION_MINIMUMS, VALID_LLM_EXECUTION_MODES, VALID_IMAGE_ARTIFACT_SOURCES, VALID_INPUT_SCOPE_MODES (+40 more)

### Community 139 - "Community 139"
Cohesion: 0.13
Nodes (10): discoverProjectConfig(), cleanupDirs, root, result, configDir, configPath, loaded, raw (+2 more)

### Community 182 - "Community 182"
Cohesion: 0.33
Nodes (7): CustomProviderConfig, CustomProviderMap, globalProvidersPath(), localProvidersPath(), LoadCustomProvidersOptions, loadCustomProviders(), providerBaseUrlOk()
...
Cohesion: 0.09
Nodes (23): __filename, __dirname, AnalysisFile, readJson(), writeJson(), scopeOptionDescription(), cacheOptionsFromRuntime(), ProfileRuntimeContext (+15 more)

### Community 164 - "Community 164"
Cohesion: 0.22
Nodes (8): StorageCliFlags, ResolveStoreConfigInput, resolveStoreConfig(), findMirror(), GraphStoreConfig, NormalizedProjectConfig, savedEnv, envKeys

### Community 13 - "Review analysis (blast radius, communities)"
Cohesion: 0.06
Nodes (42): moduleDir(), resolveToolVersion(), FileStoreClearOptions, FileGraphStore, createFileGraphStore(), moduleDir(), resolveToolVersion(), deriveNamespace() (+34 more)
...
Cohesion: 0.04
Nodes (45): PlatformConfig, GraphifyPdfOcrMode, GraphifyLlmExecutionMode, GraphifyImageArtifactSource, GraphifyProjectConfigProfile, GraphifyProjectInputs, GraphifyImageAnalysisCalibrationPolicy, GraphifyImageAnalysisBatchPolicy (+37 more)
...
Cohesion: 0.18
Nodes (19): GROUP_PALETTE, WEAK_EDGE_COLOR, finite(), clampUnit(), stableHash(), colorForGroup(), positionForNode(), nodeSize() (+11 more)
...
Cohesion: 0.20
Nodes (5): migrationResultToText(), cleanupDirs, root, result, text
...
## Knowledge Gaps
- **1743 isolated node(s):** `Nt`, `Qs`, `Js`, `ur`, `fr` (+1738 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 230`** (1 nodes): `UnpdfTextResult`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (1 nodes): `app`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 222`** (2 nodes): `buildPatchFromCandidate()`, `cand`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 224`** (2 nodes): `delta`, `G`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 234`** (2 nodes): `tempProject()`, `tempProfileProject()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (2 nodes): `ApiClient`, `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 198`** (2 nodes): `Transformer`, `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 176`** (2 nodes): `inventory`, `ignoredDir`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 235`** (1 nodes): `optionalRuntimeDeps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 178`** (1 nodes): `ConnectionPool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `buildScene()` connect `Sample corpus: httpx utils (worked/)` to `Community 203`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `loadProjectConfig()` connect `Configured dataprep (profile mode)` to `Profile discovery/extraction prompts`, `Ontology output (wiki, obsidian, etc.)`, `MCP server (graph queries)`, `Community 59`, `Community 133`, `Community 156`, `Community 148`, `Community 155`, `Community 139`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `discoverProjectConfig()` connect `Community 139` to `Profile discovery/extraction prompts`, `Ontology output (wiki, obsidian, etc.)`, `MCP server (graph queries)`, `Configured dataprep (profile mode)`, `Community 59`?**
