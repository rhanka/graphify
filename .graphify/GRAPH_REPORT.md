...
## Corpus Check
- Large corpus: 233 files · ~270 687 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2430 nodes · 4700 edges · 88 communities detected
...
- Included files: 233 · Candidates: 249
- Excluded: 0 untracked · 20188 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `f12d39b`
...
Cohesion: 0.05
Nodes (43): execGit(), gitRevParse(), resolveFromGitCwd(), resolveGitContext(), safeExecGit(), safeGitRevParse(), execGit(), gitRevParse() (+35 more)
...
Cohesion: 0.05
Nodes (32): bfs(), communitiesFromGraph(), communityName(), dfs(), findNode(), getVersion(), loadGraph(), scoreNodes() (+24 more)
...
- **Thin community `Community 64`** (1 nodes): `Client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (2 nodes): `ConnectionPool`, `HTTPTransport`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Cookies` connect `Community 51` to `Community 43`, `Community 29`, `Community 39`, `Community 20`, `Community 25`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Cookies` connect `Community 36` to `Community 43`, `Community 64`, `Community 60`, `Community 25`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `InvalidURL` connect `Community 36` to `Community 20`, `Community 64`, `Community 60`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
