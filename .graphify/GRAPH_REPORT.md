...
## Corpus Check
- Large corpus: 208 files · ~232,438 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1372 nodes · 2618 edges · 38 communities detected
...
Cohesion: 0.03
Nodes (79): addCall(), addFunction(), makeFlowStore(), qn(), analyzeChanges(), changedNodesFromFiles(), mapChangesToNodes(), sortNodesByLocation() (+71 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (40): build(), build_from_json(), buildFromJson(), buildMerge(), deduplicateByLabel(), normalizedLabel(), Merge multiple extraction results into one graph., compileNodes() (+32 more)
...
- **Thin community `Community 31`** (1 nodes): `ApiClient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (2 nodes): `build_graph()`, `Graph`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (1 nodes): `Transformer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
